...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (FlxG.save.data != null && ClientPrefs.data.systemCursor) FlxG.mouse.useSystemCursor = ClientPrefs.data.systemCursor;
		...
		mainData = Json.parse(Paths.getTextFromFile('data/mainData.json'));
...
override function beatHit()
{
	...
	if (!closedState)
	{
		...
		switch (sickBeats)
		{
			...
			case 8:
				addMoreText('Digital Hourglass', -40);
				ngSpr.visible = true;
			case 9:
				deleteCoolText();
				ngSpr.visible = false;
